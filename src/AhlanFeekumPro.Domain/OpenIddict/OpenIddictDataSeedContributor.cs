...
namespace AhlanFeekumPro.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("AhlanFeekumPro") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "AhlanFeekumPro", DisplayName = "AhlanFeekumPro API", Resources = { "AhlanFeekumPro" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        //MAUI Client
        var mauiClientId = configurationSection["AhlanFeekumPro_Maui:ClientId"];
        if (!mauiClientId.IsNullOrWhiteSpace())
        {
            var mauiClientRootUrl = configurationSection["AhlanFeekumPro_Maui:RootUrl"]?.Replace("_", "-");
            var mauiClientPostLogoutRedirectUri = configurationSection["AhlanFeekumPro_Maui:PostLogoutRedirectUri"]?.Replace("_", "-");
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["AhlanFeekumPro_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["AhlanFeekumPro_Swagger:RootUrl"]?.TrimEnd('/');
