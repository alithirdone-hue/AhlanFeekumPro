...
{
    public abstract class EfCoreGovernorateRepositoryBase : EfCoreRepository<AhlanFeekumProDbContext, Governorate, Guid>
    {
        public EfCoreGovernorateRepositoryBase(IDbContextProvider<AhlanFeekumProDbContext> dbContextProvider)
        ...
        protected virtual IQueryable<Governorate> ApplyFilter(
