...
{
    public abstract class EfCorePropertyTypeRepositoryBase : EfCoreRepository<AhlanFeekumProDbContext, PropertyType, Guid>
    {
        public EfCorePropertyTypeRepositoryBase(IDbContextProvider<AhlanFeekumProDbContext> dbContextProvider)
        ...
        public virtual async Task<List<PropertyType>> GetListAsync(
            string? filterText = null,
            string? title = null,
            int? orderMin = null,
            int? orderMax = null,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            query = query.OrderBy(string.IsNullOrWhiteSpace(sorting) ? PropertyTypeConsts.GetDefaultSorting(false) : sorting);
        ...
        protected virtual IQueryable<PropertyType> ApplyFilter(
            IQueryable<PropertyType> query,
            string? filterText = null,
            string? title = null,
            int? orderMin = null,
            int? orderMax = null,
